...
class CarEnv:
    ...
    def __init__(self, start, end):
        ...
        self.hero_vehicle = None#new added 
        # to initialize
...
#         cv2.imshow("Depth Camera Preview", depth_map / np.max(depth_map))  # Normalize for visualization
#         cv2.waitKey(1)  # Refresh the display

#         # Display the segmentation image
#         cv2.imshow("Segmentation Camera Preview", copy_seg_img)
#         cv2.waitKey(1)  # Refresh the display
